...
export const getShortDate = (date) => dayjs(date).format('YYYY-MM-DD');
...
export const getDateForInfo = (date) => dayjs(date).format('MMM DD');
...
export const isFutureOrPastEvent = (dueDate) => dayjs().isBefore(dueDate, 'D') || dayjs(dueDate).isSame(dayjs(), 'D');
